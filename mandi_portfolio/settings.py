"""
Django settings for mandi_portfolio project.
...
SECRET_KEY = 'django-insecure-mn(((2^g59+(8bxfq0r7@(9z%ie!ilc9s(%6jy$sdfr#c%@&x*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['gcode1.pythonanywhere.com']
...
ROOT_URLCONF = 'mandi_portfolio.urls'
...
WSGI_APPLICATION = 'mandi_portfolio.wsgi.application'
